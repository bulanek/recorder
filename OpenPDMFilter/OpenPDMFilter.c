...
void Open_PDM_Filter_Init(TPDMFilter_InitStruct *Param)
{
  ...
  Param->LP_ALFA = (Param->LP_HZ != 0 ? (uint16_t) (Param->LP_HZ * 256 / (Param->LP_HZ + Param->Fs / (2 * PI))) : 0);
  Param->HP_ALFA = (Param->HP_HZ != 0 ? (uint16_t) (Param->Fs * 256 / (2 * PI * Param->HP_HZ + Param->Fs)) : 0);
