...
#define UART_TASK_NAME "TaskUART"
...
const uint16_t UART_TASK_QUEUE_NUM_ITEMS = 40;
const uint16_t NV_TASK_QUEUE_NUM_ITEMS = 40;
const uint16_t PDM_PCM_TASK_QUEUE_NUM_ITEMS = 40;
